...
import {Jumbotron,Accordion, Card, Button, Container, Row, Col, } from 'react-bootstrap';
          ...
          <h1 className="text-center">Let's Get Cooking!</h1>
            ...
            <Row>
                ...
                <Col lg={4}  className="video-container">
                    <iframe title="Cooking" width="340" height="380"  src="https://www.youtube.com/embed/DqhqIfHww7g" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"></iframe>
                    <Accordion >
                ...
                <Col lg={4} className="video-container">
                <iframe title="tasty"width="340" height="380"  src="https://www.youtube.com/embed/FcKvYl-GaAA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <Accordion >
                        <Card className=" mt-1 shadow border"style={{ width: 'auto' }}>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="success" eventKey="0">
...
Preheat the oven to 350˚F (180˚C).Sprinkle flour on the work surface and rolling pin so the dough won’t stick. Roll out the dough to ¼- to ⅛-inch (6- to 3-mm) thickness. Using a 3-inch (7-cm) round cookie cutter, cut out the dough.
...
Enjoy!
                ...
                <Col lg={4} className="video-container">
                <iframe title= "cooking" width="340" height="380" src="https://www.youtube.com/embed/vrpof_QQUe0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <Accordion >
                        <Card className=" mt-1 shadow border"style={{ width: 'auto'}}>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="success" eventKey="0">
...
Enjoy!
                ...
                <Row>
<Col lg={4} className="video-container">
<iframe title="cooking" width="340" height="380" src="https://www.youtube.com/embed/fuEkA9rG_nI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <Accordion >
                        <Card className=" mt-1 shadow border" style={{ width: 'auto' }}>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="success" eventKey="0">
...
Let cool for 20 minutes before icing. 
                ...
                <Col lg={4} className="video-container">
                <iframe title="cooking" width="350" height="380" src="https://www.youtube.com/embed/zrXWIWlF5_M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <Accordion >
                        <Card className=" mt-1 shadow border"style={{ width: 'auto' }}>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="success" eventKey="0">
...
<br/>
  ...
  Mix 1 tbsp cocoa powder, 3 tbsp flour, 1/8 tsp salt, 1/4 tsp baking powder, 1 tbsp sugar, 3 tsp coconut or vegetable oil, 3 tbsp milk, 1/2 tsp pure vanilla extract and 1 tbsp kid-friendly protein powder in a bowl. Pour into a mug and microwave for 1-1.5 minutes.
                ...
                <Col lg={4} className="video-container">
                <iframe title="cooking" width="340" height="380"  src="https://www.youtube.com/embed/CpDqOH3uyAI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <Accordion >
                        <Card className=" mt-1 shadow border"style={{ width: 'auto' }}>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="success" eventKey="0">
...
Preparation
<br/>
  In an electric mixer with a whisk attachment (or large bowl with hand mixer) add whipping cream and vanilla, mix starting on low and move it to a medium-high speed until you have soft peaks. Add in powdered sugar and mix until you have medium peaks. Set aside.

  Unwrap and place 4 ice cream sandwiches on your serving plate.

  Add two large scoops of whipped cream on top of the ice cream sandwiches and smooth out until flat. 

  Add candies and drizzle fudge sauce (heat in microwave for about 20 seconds if not drizzling well).
...
<br/>
  ...
  Fold in whipped cream with a spatula

  Add chocolate chips

  Fill piping bag with mixture using a large piping tip

  Pipe filling into a cone, going above the edge.

  Sprinkle chocolate chips on top and serve
...
<br/>
  ...
  Stir in frozen raspberries, smushing them to release their juices.

  Mix in chocolate chips.

   Freeze for 30 minutes.  Stir.  Freeze again for 15 min longer.  Serve!
