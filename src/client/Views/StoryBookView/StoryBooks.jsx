    ...
    >
      <Card className="mt-4 ml-4 mr-4 mt-4 " style={{ width: "28rem" }}>
        <iframe
          ...
          width="400"
          height="315"
          src="https://www.youtube.com/embed/6s7aSNUCkiM"
          frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"
        ></iframe>
        <Card.Body>
          <h3>When a Dragon Moves In</h3>
          <Card.Text>
...
>>>>>>> yes chef
      ...
      <Card className="mt-4 ml-4 mr-4 mt-4 " style={{ width: "28rem" }}>
        <iframe
          ...
          width="400"
          height="315"
          src="https://www.youtube.com/embed/p_LeUSA-qIg"
          frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"
        ></iframe>
        <Card.Body>
          <h3>The Tale of Peter Rabbit</h3>
          <Card.Text>
      ...
      <Card className="mt-4 ml-4 mr-4 mt-4 " style={{ width: "28rem" }}>
        <iframe
          ...
          width="400"
          height="315"
          src="https://www.youtube.com/embed/-UO-fLPG1kg"
          frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"
        ></iframe>
        <Card.Body>
      ...
      <Card className="mt-4 ml-4 mr-4 mt-4 " style={{ width: "28rem" }}>
        <iframe
          ...
          width="400"
          height="315"
          src="https://www.youtube.com/embed/Xb3bXKAkeek"
          frameborder="0"
          allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture; fullscreen"
        ></iframe>
        <Card.Body>
      ...
      <Card className="mt-4 ml-4 mr-4 mt-4 " style={{ width: "28rem" }}>
        ...
        <h3>Chester's Way</h3>
          <Card.Text>
            ...
            <br />
            Read by: Vanessa Marano & Katie Leclerc
          </Card.Text>
        </Card.Body>
      </Card>
