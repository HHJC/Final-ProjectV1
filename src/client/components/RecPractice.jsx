...
class RecPractice extends React.Component {
  render() {
    return (
          ...
          <div className="mx-auto">
            <Accordion>
              <Card style={{ width: "18rem" }}>
                <Card.Header>
                  <Accordion.Toggle as={Button} variant="link" eventKey="0">
                    EAT| 3 breakfast recipes your kids can cook
                  </Accordion.Toggle>
                </Card.Header>
                <Accordion.Collapse eventKey="0">
                  <Card.Body>
                    ...
                    <hr />
                    Take 1 banana and mash into a bowl with 2 eggs. Wisk and
                    scoop into a hot pan. Flip when ready, enjoy!
                    <hr />
              ...
              <Card style={{ width: "18rem" }}>
                <Card.Header>
                  <Accordion.Toggle as={Button} variant="link" eventKey="1">
                    8 Fun and Creative Recipes To Make With Your Kids • Tasty
                  </Accordion.Toggle>
                </Card.Header>
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body>
                    "Sugar Cookie Pizza" ½ cup unsalted butter, 1 stick,
                    softened 1 ½ teaspoons vanilla extract, divided ½ cup
                    granulated sugar 3 tablespoons light brown sugar 1 large
                    egg, room temperature 1 ½ cups all-purpose flour 1 teaspoon
                    cream of tartar ½ teaspoon baking soda 1 pinch salt 6 oz
                    cream cheese, room temperature ⅓ cup powdered sugar ⅓ cup
                    chocolate hazelnut spread OPTIONAL TOPPINGS 1 cup fresh
                    berries peanut butter mini pretzel ½ cup fruit cereal
                    Preparation Preheat the oven to 350˚F (180˚C). Line a
                    10-inch (25-cm) cast iron pan with parchment paper. In a
                    large bowl, mix the butter with 1 teaspoon of vanilla
                    extract until light and fluffy. Add the granulated sugar,
                    then the brown sugar, and mix until well incorporated.
                  </Card.Body>
                </Accordion.Collapse>
              </Card>
              <Card style={{ width: "18rem" }}>
