...
<Card className="m-3 mt-5 shadow border" style={{ width: '18rem' }}>
  ...
  <Card.Body>
    ...
    <Button className="btn btn-primary m-auto d-flex"><FaBookReader className="m-1 d-flex align-bottom" /> Say It With Me</Button>
  </Card.Body>
</Card>
...
<Card className="m-3 mt-3 shadow border" style={{ width: '18rem' }}>
  ...
  <Card.Body>
    ...
    <Button onClick={()=>history.push('./Views/Animalsview/Animals')} className="btn btn-warning m-auto d-flex"><FaDog className="m-1 d-flex align-bottom"/>What Creature Is That</Button>
  </Card.Body>
</Card>
