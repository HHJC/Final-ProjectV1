...
<Card className="mt-4 ml-4 mr-4 mt-4 shadow border" style={{ width: '18rem' }}>
  ...
  <Card.Body>
    ...
    <Button /* onClick={()=>history.push('./Views/StoryBooks')} */ className="btn btn-danger mx-1"><GiCardRandom /> Flash Cards</Button>
  </Card.Body>
</Card>
  ...
  <Card.Body>
    ...
    <Card.Text>
     Find a story Book and read along with them.
      ...
      <Button onClick={()=>history.push('./Views/StoryBooks')} className="btn btn-success mx-1"><GiBookshelf/> Pick your Story</Button>
  </Card.Body>
</Card>
...
<Card className="mt-4 ml-4 mr-4 mt-4 shadow border" style={{ width: '18rem' }}>
  ...
  <Card.Body>
    ...
    <Button className="btn btn-primary mx-1"><FaDog/> What Creature Is That</Button>
  </Card.Body>
</Card>
